...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-slate-800">Tambah Cabang</h2>
        </template>
                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit" class="max-w-md space-y-6">
                            <div>
                                ...
                                <TextInput id="code" v-model="form.code" class="mt-1 block w-full" placeholder="PST" autofocus />
                                <InputError :message="form.errors.code" />
                            </div>

                            <div>
                                <InputLabel for="name" value="Nama Cabang" />
                                <TextInput id="name" v-model="form.name" class="mt-1 block w-full" placeholder="Pusat" />
