...
onMounted(() => {
    ...
    if (form.category_id) {
        form.sku = generateSku(form.category_id)
    }
})
...
const isFormValid = computed(() => form.name && form.sku && form.sell_price)
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-slate-800">Tambah Produk</h2>
        </template>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 flex gap-2">
                                        <TextInput id="sku" v-model="form.sku" class="block flex-1" placeholder="Otomatis berdasarkan kategori" />
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 flex gap-2">
                                        <TextInput id="barcode" v-model="form.barcode" class="block flex-1" placeholder="Otomatis terisi" />
